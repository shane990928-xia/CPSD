...
export WANDB_NAME="${WANDB_NAME:-webshop_grpo_qwen2.5_1.7b_sft_no_skills_test}"
...
default_local_dir="${DEFAULT_LOCAL_DIR:-outputs/test_webshop_no_skills}"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=test_webshop_no_skills \
