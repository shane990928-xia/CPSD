...
export WANDB_NAME="webshop_grpo_qwen2.5_1.7b_sft_skills_dynamic"

num_cpus_per_env_worker=0.1 # The CPU resource allocated for each environment worker. If you want to use less CPU resources, you can decrease this value.

train_data_size=8  # Moderate size
...
python3 -m verl.trainer.main_ppo \
    ...
    +env.skills_only_memory.skills_json_path=/home/dataset-assist-0/xiaxu/code/SkillRL/memory_data/webshop/claude_style_skills.json \
